...
__Overall Results:__ As of 3/22/21, the FYE-101 Login Rate for the test group was **4.1 percentage points higher (+4.8% change)**. This difference is statistically significant with a 95% confidence level and two-sided test of proportions. See [appendix](#stats) for more detail on how to interpret the results.
...
+ __Melt Rate__ The post-start melt rate for the test group was **-1.4 percentage points lower (-15.1% change)**. This difference is not statistically significant with a 95% confidence level and two-sided test of proportions.
