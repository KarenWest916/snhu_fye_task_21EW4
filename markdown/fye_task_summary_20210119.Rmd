...
+ __Statistical Significance:__ A test result is said to be "statistically significant" when the difference between the two results is too big to have been a result of chance.

+ __One-Sided versus Two-Sided Test__ A one sided test is used when the statistical test only needs to prove that an increase in conversions (i.e. the metric) for the test group is significant; it does not consider whether any decrease in conversions is significant. A two-sided test evaluates the significance of the test group conversions being higher or lower. If we want to be certain that a treatment being tested does not have a negative impact on the metric, then a two-sided test should be conducted.
