...
+ __Melt Rate__ The post-start melt rate for the test group was **-1.3 percentage points lower (-13.8% change)**. This difference is not statistically significant with a 95% confidence level and two-sided test of proportions. Even though the change is not statistically significant, the lower melt rate is a positive indication of the potential influence of student engagement with the course.
