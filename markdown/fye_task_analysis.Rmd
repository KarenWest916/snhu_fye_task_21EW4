 ...
 gt() %>%
   ...
   tab_header(
    title = md("21EW4 FYE-101 Task & Email: Test vs. Control")) %>% 
      tab_footnote(
    footnote = "Registered and had course interaction",
    ...
    tab_source_note(
    source_note = c("Data Source:  Unify Opportunity, Course Enrollment, New Starts Historical - retrieved on 3/19/21"))
  #%>%
...
fye_results %>% gtsave(filename = "fye_task_21EW4_20210319.png", path = here::here("imgs"))
```